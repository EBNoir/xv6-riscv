...
int main(void){
  ...
  16:	7ce50513          	add	a0,a0,1998 # 7e0 <malloc+0xec>
  1a:	00000097          	auipc	ra,0x0
  1e:	622080e7          	jalr	1570(ra) # 63c <printf>
    printf("pid padre: %d\n",getppid());
  22:	00000097          	auipc	ra,0x0
  26:	34a080e7          	jalr	842(ra) # 36c <getppid>
  2a:	85aa                	mv	a1,a0
  2c:	00000517          	auipc	a0,0x0
  30:	7c450513          	add	a0,a0,1988 # 7f0 <malloc+0xfc>
  34:	00000097          	auipc	ra,0x0
  38:	608080e7          	jalr	1544(ra) # 63c <printf>
    return 0;
  3c:	4501                	li	a0,0
  3e:	60a2                	ld	ra,8(sp)
  40:	6402                	ld	s0,0(sp)
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c0:	34c70713          	add	a4,a4,844 # 808 <malloc+0x114>
 ...
 54a:	31ab8b93          	add	s7,s7,794 # 860 <digits>
 ...
 59e:	26690913          	add	s2,s2,614 # 800 <malloc+0x10c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 744:	8c090913          	add	s2,s2,-1856 # 1000 <freep>
  if(p == (char*)-1)
 748:	5afd                	li	s5,-1
 74a:	a895                	j	7be <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 74c:	00001797          	auipc	a5,0x1
 750:	8c478793          	add	a5,a5,-1852 # 1010 <base>
