...
w_mscratch(uint64 x)
{
  ...
  asm volatile("csrw mtvec, %0" : : "r" (x));
    ...
    80000066:	b0e78793          	add	a5,a5,-1266 # 80005b70 <timervec>
...
0000000080001c7e <userinit>:
{
  ...
  uvmfirst(p->pagetable, initcode, sizeof(initcode));
    ...
    80001ca2:	bd258593          	add	a1,a1,-1070 # 80008870 <initcode>
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    8000264e:	49678793          	add	a5,a5,1174 # 80005ae0 <kernelvec>
    ...
    8000273e:	0807df63          	bgez	a5,800027dc <devintr+0xa4>
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80002770:	47c080e7          	jalr	1148(ra) # 80005be8 <plic_claim>
    ...
    8000279e:	472080e7          	jalr	1138(ra) # 80005c0c <plic_complete>
    return 1;
    ...
    800027b4:	922080e7          	jalr	-1758(ra) # 800060d2 <virtio_disk_intr>
    if(irq)
...
00000000800027de <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    800027f8:	2ec78793          	add	a5,a5,748 # 80005ae0 <kernelvec>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002d98:	77458593          	add	a1,a1,1908 # 80008508 <syscalls+0xb8>
  ...
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    ...
    80002dd4:	740a0a13          	add	s4,s4,1856 # 80008510 <syscalls+0xc0>
    b->next = bcache.head.next;
...
bread(uint dev, uint blockno)
{
  ...
  panic("bget: no buffers");
    ...
    80002ea6:	67650513          	add	a0,a0,1654 # 80008518 <syscalls+0xc8>
  ...
  return b;
    ...
    80002efa:	fac080e7          	jalr	-84(ra) # 80005ea2 <virtio_disk_rw>
    b->valid = 1;
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002f24:	f82080e7          	jalr	-126(ra) # 80005ea2 <virtio_disk_rw>
}
    ...
    80002f36:	5fe50513          	add	a0,a0,1534 # 80008530 <syscalls+0xe0>
...
brelse(struct buf *b)
{
  ...
  release(&bcache.lock);
    ...
    80002fd2:	56a50513          	add	a0,a0,1386 # 80008538 <syscalls+0xe8>
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    800030c6:	47e50513          	add	a0,a0,1150 # 80008540 <syscalls+0xf0>
...
00000000800030d2 <balloc>:
{
  ...
  printf("balloc: out of blocks\n");
    ...
    800031f4:	36850513          	add	a0,a0,872 # 80008558 <syscalls+0x108>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800032e2:	29250513          	add	a0,a0,658 # 80008570 <syscalls+0x120>
...
00000000800032ee <iget>:
{
  ...
  release(&itable.lock);
    ...
    8000339e:	1ee50513          	add	a0,a0,494 # 80008588 <syscalls+0x138>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    8000341e:	17e50513          	add	a0,a0,382 # 80008598 <syscalls+0x148>
...
000000008000342a <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    8000343c:	17858593          	add	a1,a1,376 # 800085b0 <syscalls+0x160>
  ...
  for(i = 0; i < NINODE; i++) {
    ...
    80003464:	15890913          	add	s2,s2,344 # 800085b8 <syscalls+0x168>
...
000000008000348a <ialloc>:
{
  ...
  printf("ialloc: no inodes\n");
    ...
    800034fc:	0c850513          	add	a0,a0,200 # 800085c0 <syscalls+0x170>
...
0000000080003622 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80003656:	f8650513          	add	a0,a0,-122 # 800085d8 <syscalls+0x188>
    ...
    800036d8:	f0c50513          	add	a0,a0,-244 # 800085e0 <syscalls+0x190>
...
00000000800036e4 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80003724:	ed050513          	add	a0,a0,-304 # 800085f0 <syscalls+0x1a0>
...
0000000080003d16 <dirlink>:
{
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003dbc:	86850513          	add	a0,a0,-1944 # 80008620 <syscalls+0x1d0>
...
0000000080003f30 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003f4e:	6e658593          	add	a1,a1,1766 # 80008630 <syscalls+0x1e0>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800040c4:	57850513          	add	a0,a0,1400 # 80008638 <syscalls+0x1e8>
...
log_write(struct buf *b)
{
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    8000422e:	41e50513          	add	a0,a0,1054 # 80008648 <syscalls+0x1f8>
    80004232:	ffffc097          	auipc	ra,0xffffc
    80004236:	30a080e7          	jalr	778(ra) # 8000053c <panic>
    panic("log_write outside of trans");
    8000423a:	00004517          	auipc	a0,0x4
    8000423e:	42650513          	add	a0,a0,1062 # 80008660 <syscalls+0x210>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80004292:	3f258593          	add	a1,a1,1010 # 80008680 <syscalls+0x230>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800043b4:	2e058593          	add	a1,a1,736 # 80008690 <syscalls+0x240>
...
filedup(struct file *f)
{
  ...
  return f;
    ...
    80004480:	21c50513          	add	a0,a0,540 # 80008698 <syscalls+0x248>
...
fileclose(struct file *f)
{
  ...
  if(ff.type == FD_PIPE){
    ...
    80004518:	18c50513          	add	a0,a0,396 # 800086a0 <syscalls+0x250>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80004670:	04450513          	add	a0,a0,68 # 800086b0 <syscalls+0x260>
    ...
    8000468c:	10078e63          	beqz	a5,800047a8 <filewrite+0x120>
{
  ...
  return ret;
    ...
    8000479c:	f2850513          	add	a0,a0,-216 # 800086c0 <syscalls+0x270>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80004810:	ec458593          	add	a1,a1,-316 # 800086d0 <syscalls+0x280>
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004bfa:	ae250513          	add	a0,a0,-1310 # 800086d8 <syscalls+0x288>
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    8000504e:	6ae58593          	add	a1,a1,1710 # 800086f8 <syscalls+0x2a8>
    ...
    80005066:	69e58593          	add	a1,a1,1694 # 80008700 <syscalls+0x2b0>
...
000000008000521c <sys_getppid>:
{
    8000521c:	1141                	add	sp,sp,-16
    8000521e:	e406                	sd	ra,8(sp)
    80005220:	e022                	sd	s0,0(sp)
    80005222:	0800                	add	s0,sp,16
    struct proc *my_proc = myproc();
    80005224:	ffffc097          	auipc	ra,0xffffc
    80005228:	782080e7          	jalr	1922(ra) # 800019a6 <myproc>
    printf("pid actual: %d\n", pid);
    8000522c:	590c                	lw	a1,48(a0)
    8000522e:	00003517          	auipc	a0,0x3
    80005232:	4da50513          	add	a0,a0,1242 # 80008708 <syscalls+0x2b8>
    80005236:	ffffb097          	auipc	ra,0xffffb
    8000523a:	350080e7          	jalr	848(ra) # 80000586 <printf>
}
...
000000008000528e <sys_link>:
{
  ...
  begin_op();
    ...
    800052ce:	cfe080e7          	jalr	-770(ra) # 80003fc8 <begin_op>
  if((ip = namei(old)) == 0){
    800052d2:	ed040513          	add	a0,s0,-304
    800052d6:	fffff097          	auipc	ra,0xfffff
    800052da:	af2080e7          	jalr	-1294(ra) # 80003dc8 <namei>
    800052de:	84aa                	mv	s1,a0
    800052e0:	c551                	beqz	a0,8000536c <sys_link+0xde>
  ilock(ip);
    800052e2:	ffffe097          	auipc	ra,0xffffe
    800052e6:	340080e7          	jalr	832(ra) # 80003622 <ilock>
  if(ip->type == T_DIR){
    800052ea:	04449703          	lh	a4,68(s1)
    800052ee:	4785                	li	a5,1
    800052f0:	08f70463          	beq	a4,a5,80005378 <sys_link+0xea>
  ip->nlink++;
    800052f4:	04a4d783          	lhu	a5,74(s1)
    800052f8:	2785                	addw	a5,a5,1
    800052fa:	04f49523          	sh	a5,74(s1)
  iupdate(ip);
    800052fe:	8526                	mv	a0,s1
    80005300:	ffffe097          	auipc	ra,0xffffe
    80005304:	256080e7          	jalr	598(ra) # 80003556 <iupdate>
  iunlock(ip);
    80005308:	8526                	mv	a0,s1
    8000530a:	ffffe097          	auipc	ra,0xffffe
    8000530e:	3da080e7          	jalr	986(ra) # 800036e4 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
    80005312:	fd040593          	add	a1,s0,-48
    80005316:	f5040513          	add	a0,s0,-176
    8000531a:	fffff097          	auipc	ra,0xfffff
    8000531e:	acc080e7          	jalr	-1332(ra) # 80003de6 <nameiparent>
    80005322:	892a                	mv	s2,a0
    80005324:	c935                	beqz	a0,80005398 <sys_link+0x10a>
  ilock(dp);
    80005326:	ffffe097          	auipc	ra,0xffffe
    8000532a:	2fc080e7          	jalr	764(ra) # 80003622 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
    ...
    8000533a:	fd040593          	add	a1,s0,-48
    8000533e:	854a                	mv	a0,s2
    80005340:	fffff097          	auipc	ra,0xfffff
    80005344:	9d6080e7          	jalr	-1578(ra) # 80003d16 <dirlink>
  ...
  iput(ip);
    ...
    8000535c:	484080e7          	jalr	1156(ra) # 800037dc <iput>
  end_op();
    80005360:	fffff097          	auipc	ra,0xfffff
    80005364:	ce2080e7          	jalr	-798(ra) # 80004042 <end_op>
  return 0;
    80005368:	4781                	li	a5,0
    8000536a:	a085                	j	800053ca <sys_link+0x13c>
    end_op();
    8000536c:	fffff097          	auipc	ra,0xfffff
    80005370:	cd6080e7          	jalr	-810(ra) # 80004042 <end_op>
    return -1;
    ...
    8000537e:	50a080e7          	jalr	1290(ra) # 80003884 <iunlockput>
    end_op();
    80005382:	fffff097          	auipc	ra,0xfffff
    80005386:	cc0080e7          	jalr	-832(ra) # 80004042 <end_op>
    return -1;
    ...
    80005394:	4f4080e7          	jalr	1268(ra) # 80003884 <iunlockput>
  ilock(ip);
    80005398:	8526                	mv	a0,s1
    8000539a:	ffffe097          	auipc	ra,0xffffe
    8000539e:	288080e7          	jalr	648(ra) # 80003622 <ilock>
  ip->nlink--;
    800053a2:	04a4d783          	lhu	a5,74(s1)
    800053a6:	37fd                	addw	a5,a5,-1
    800053a8:	04f49523          	sh	a5,74(s1)
  iupdate(ip);
    800053ac:	8526                	mv	a0,s1
    800053ae:	ffffe097          	auipc	ra,0xffffe
    800053b2:	1a8080e7          	jalr	424(ra) # 80003556 <iupdate>
  iunlockput(ip);
    800053b6:	8526                	mv	a0,s1
    800053b8:	ffffe097          	auipc	ra,0xffffe
    800053bc:	4cc080e7          	jalr	1228(ra) # 80003884 <iunlockput>
  end_op();
    800053c0:	fffff097          	auipc	ra,0xfffff
    800053c4:	c82080e7          	jalr	-894(ra) # 80004042 <end_op>
  return -1;
    ...
    800053d4:	6155                	add	sp,sp,304
    800053d6:	8082                	ret

00000000800053d8 <sys_unlink>:
{
    800053d8:	7151                	add	sp,sp,-240
    ...
    800053e4:	1980                	add	s0,sp,240
  if(argstr(0, path, MAXPATH) < 0)
    800053e6:	08000613          	li	a2,128
    800053ea:	f3040593          	add	a1,s0,-208
    800053ee:	4501                	li	a0,0
    800053f0:	ffffd097          	auipc	ra,0xffffd
    800053f4:	710080e7          	jalr	1808(ra) # 80002b00 <argstr>
    800053f8:	18054163          	bltz	a0,8000557a <sys_unlink+0x1a2>
  begin_op();
    800053fc:	fffff097          	auipc	ra,0xfffff
    80005400:	bcc080e7          	jalr	-1076(ra) # 80003fc8 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
    80005404:	fb040593          	add	a1,s0,-80
    80005408:	f3040513          	add	a0,s0,-208
    8000540c:	fffff097          	auipc	ra,0xfffff
    80005410:	9da080e7          	jalr	-1574(ra) # 80003de6 <nameiparent>
    80005414:	84aa                	mv	s1,a0
    80005416:	c979                	beqz	a0,800054ec <sys_unlink+0x114>
  ilock(dp);
    80005418:	ffffe097          	auipc	ra,0xffffe
    8000541c:	20a080e7          	jalr	522(ra) # 80003622 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    80005420:	00003597          	auipc	a1,0x3
    80005424:	2d858593          	add	a1,a1,728 # 800086f8 <syscalls+0x2a8>
    80005428:	fb040513          	add	a0,s0,-80
    8000542c:	ffffe097          	auipc	ra,0xffffe
    80005430:	6c0080e7          	jalr	1728(ra) # 80003aec <namecmp>
    80005434:	14050a63          	beqz	a0,80005588 <sys_unlink+0x1b0>
    80005438:	00003597          	auipc	a1,0x3
    8000543c:	2c858593          	add	a1,a1,712 # 80008700 <syscalls+0x2b0>
    80005440:	fb040513          	add	a0,s0,-80
    80005444:	ffffe097          	auipc	ra,0xffffe
    80005448:	6a8080e7          	jalr	1704(ra) # 80003aec <namecmp>
    8000544c:	12050e63          	beqz	a0,80005588 <sys_unlink+0x1b0>
  if((ip = dirlookup(dp, name, &off)) == 0)
    80005450:	f2c40613          	add	a2,s0,-212
    80005454:	fb040593          	add	a1,s0,-80
    80005458:	8526                	mv	a0,s1
    8000545a:	ffffe097          	auipc	ra,0xffffe
    8000545e:	6ac080e7          	jalr	1708(ra) # 80003b06 <dirlookup>
    80005462:	892a                	mv	s2,a0
    80005464:	12050263          	beqz	a0,80005588 <sys_unlink+0x1b0>
  ilock(ip);
    80005468:	ffffe097          	auipc	ra,0xffffe
    8000546c:	1ba080e7          	jalr	442(ra) # 80003622 <ilock>
  if(ip->nlink < 1)
    80005470:	04a91783          	lh	a5,74(s2)
    80005474:	08f05263          	blez	a5,800054f8 <sys_unlink+0x120>
  if(ip->type == T_DIR && !isdirempty(ip)){
    80005478:	04491703          	lh	a4,68(s2)
  ...
  iunlockput(dp);
    ...
    800054be:	3ca080e7          	jalr	970(ra) # 80003884 <iunlockput>
  ip->nlink--;
    800054c2:	04a95783          	lhu	a5,74(s2)
    800054c6:	37fd                	addw	a5,a5,-1
    800054c8:	04f91523          	sh	a5,74(s2)
  iupdate(ip);
    800054cc:	854a                	mv	a0,s2
    800054ce:	ffffe097          	auipc	ra,0xffffe
    800054d2:	088080e7          	jalr	136(ra) # 80003556 <iupdate>
  iunlockput(ip);
    800054d6:	854a                	mv	a0,s2
    800054d8:	ffffe097          	auipc	ra,0xffffe
    800054dc:	3ac080e7          	jalr	940(ra) # 80003884 <iunlockput>
  end_op();
    800054e0:	fffff097          	auipc	ra,0xfffff
    800054e4:	b62080e7          	jalr	-1182(ra) # 80004042 <end_op>
  return 0;
    800054e8:	4501                	li	a0,0
    800054ea:	a84d                	j	8000559c <sys_unlink+0x1c4>
    end_op();
    800054ec:	fffff097          	auipc	ra,0xfffff
    800054f0:	b56080e7          	jalr	-1194(ra) # 80004042 <end_op>
    return -1;
    800054f4:	557d                	li	a0,-1
    800054f6:	a05d                	j	8000559c <sys_unlink+0x1c4>
    panic("unlink: nlink < 1");
    800054f8:	00003517          	auipc	a0,0x3
    800054fc:	22050513          	add	a0,a0,544 # 80008718 <syscalls+0x2c8>
    80005500:	ffffb097          	auipc	ra,0xffffb
    80005504:	03c080e7          	jalr	60(ra) # 8000053c <panic>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    80005508:	04c92703          	lw	a4,76(s2)
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80005548:	1ec50513          	add	a0,a0,492 # 80008730 <syscalls+0x2e0>
    8000554c:	ffffb097          	auipc	ra,0xffffb
    80005550:	ff0080e7          	jalr	-16(ra) # 8000053c <panic>
    panic("unlink: writei");
    80005554:	00003517          	auipc	a0,0x3
    80005558:	1f450513          	add	a0,a0,500 # 80008748 <syscalls+0x2f8>
    8000555c:	ffffb097          	auipc	ra,0xffffb
    80005560:	fe0080e7          	jalr	-32(ra) # 8000053c <panic>
    dp->nlink--;
    ...
    80005574:	fe6080e7          	jalr	-26(ra) # 80003556 <iupdate>
    ...
    80005584:	304080e7          	jalr	772(ra) # 80003884 <iunlockput>
  iunlockput(dp);
    80005588:	8526                	mv	a0,s1
    8000558a:	ffffe097          	auipc	ra,0xffffe
    8000558e:	2fa080e7          	jalr	762(ra) # 80003884 <iunlockput>
  end_op();
    80005592:	fffff097          	auipc	ra,0xfffff
    80005596:	ab0080e7          	jalr	-1360(ra) # 80004042 <end_op>
  return -1;
...
sys_open(void)
{
  ...
  argint(1, &omode);
    800055b8:	f4c40593          	add	a1,s0,-180
    800055bc:	4505                	li	a0,1
    800055be:	ffffd097          	auipc	ra,0xffffd
    800055c2:	502080e7          	jalr	1282(ra) # 80002ac0 <argint>
  if((n = argstr(0, path, MAXPATH)) < 0)
    800055c6:	08000613          	li	a2,128
    800055ca:	f5040593          	add	a1,s0,-176
    800055ce:	4501                	li	a0,0
    800055d0:	ffffd097          	auipc	ra,0xffffd
    800055d4:	530080e7          	jalr	1328(ra) # 80002b00 <argstr>
    800055d8:	87aa                	mv	a5,a0
    return -1;
    800055da:	557d                	li	a0,-1
  if((n = argstr(0, path, MAXPATH)) < 0)
    800055dc:	0a07c863          	bltz	a5,8000568c <sys_open+0xe2>

  begin_op();
    800055e0:	fffff097          	auipc	ra,0xfffff
    800055e4:	9e8080e7          	jalr	-1560(ra) # 80003fc8 <begin_op>

  if(omode & O_CREATE){
    800055e8:	f4c42783          	lw	a5,-180(s0)
    800055ec:	2007f793          	and	a5,a5,512
    800055f0:	cbdd                	beqz	a5,800056a6 <sys_open+0xfc>
    ip = create(path, T_FILE, 0, 0);
    800055f2:	4681                	li	a3,0
    800055f4:	4601                	li	a2,0
    800055f6:	4589                	li	a1,2
    800055f8:	f5040513          	add	a0,s0,-176
    800055fc:	00000097          	auipc	ra,0x0
    80005600:	94e080e7          	jalr	-1714(ra) # 80004f4a <create>
    80005604:	84aa                	mv	s1,a0
    if(ip == 0){
    80005606:	c951                	beqz	a0,8000569a <sys_open+0xf0>
      end_op();
      return -1;
    }
  }
  ...
  if(ip->type == T_DEVICE && (ip->major < 0 || ip->major >= NDEV)){
    ...
    8000560e:	00f71763          	bne	a4,a5,8000561c <sys_open+0x72>
    80005612:	0464d703          	lhu	a4,70(s1)
    80005616:	47a5                	li	a5,9
    80005618:	0ce7ec63          	bltu	a5,a4,800056f0 <sys_open+0x146>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    ...
    80005620:	db4080e7          	jalr	-588(ra) # 800043d0 <filealloc>
    80005624:	892a                	mv	s2,a0
    80005626:	c56d                	beqz	a0,80005710 <sys_open+0x166>
    80005628:	00000097          	auipc	ra,0x0
    8000562c:	8e0080e7          	jalr	-1824(ra) # 80004f08 <fdalloc>
    80005630:	89aa                	mv	s3,a0
    80005632:	0c054a63          	bltz	a0,80005706 <sys_open+0x15c>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if(ip->type == T_DEVICE){
    ...
    8000563c:	0ef70563          	beq	a4,a5,80005726 <sys_open+0x17c>
    f->type = FD_DEVICE;
    f->major = ip->major;
  } else {
    f->type = FD_INODE;
    80005640:	4789                	li	a5,2
    80005642:	00f92023          	sw	a5,0(s2)
    f->off = 0;
    80005646:	02092023          	sw	zero,32(s2)
  }
  f->ip = ip;
    8000564a:	00993c23          	sd	s1,24(s2)
  f->readable = !(omode & O_WRONLY);
    8000564e:	f4c42783          	lw	a5,-180(s0)
    80005652:	0017c713          	xor	a4,a5,1
    80005656:	8b05                	and	a4,a4,1
    80005658:	00e90423          	sb	a4,8(s2)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
    8000565c:	0037f713          	and	a4,a5,3
    80005660:	00e03733          	snez	a4,a4
    80005664:	00e904a3          	sb	a4,9(s2)

  if((omode & O_TRUNC) && ip->type == T_FILE){
    80005668:	4007f793          	and	a5,a5,1024
    8000566c:	c791                	beqz	a5,80005678 <sys_open+0xce>
    8000566e:	04449703          	lh	a4,68(s1)
    80005672:	4789                	li	a5,2
    80005674:	0cf70063          	beq	a4,a5,80005734 <sys_open+0x18a>
    itrunc(ip);
  }
  ...
  iunlock(ip);
    ...
    8000567e:	06a080e7          	jalr	106(ra) # 800036e4 <iunlock>
  end_op();
    80005682:	fffff097          	auipc	ra,0xfffff
    80005686:	9c0080e7          	jalr	-1600(ra) # 80004042 <end_op>
  ...
  return fd;
    ...
    80005696:	6129                	add	sp,sp,192
    80005698:	8082                	ret
      end_op();
    8000569a:	fffff097          	auipc	ra,0xfffff
    8000569e:	9a8080e7          	jalr	-1624(ra) # 80004042 <end_op>
      return -1;
    800056a2:	557d                	li	a0,-1
    800056a4:	b7e5                	j	8000568c <sys_open+0xe2>
    if((ip = namei(path)) == 0){
    800056a6:	f5040513          	add	a0,s0,-176
    800056aa:	ffffe097          	auipc	ra,0xffffe
    800056ae:	71e080e7          	jalr	1822(ra) # 80003dc8 <namei>
    800056b2:	84aa                	mv	s1,a0
    800056b4:	c905                	beqz	a0,800056e4 <sys_open+0x13a>
    ilock(ip);
    800056b6:	ffffe097          	auipc	ra,0xffffe
    800056ba:	f6c080e7          	jalr	-148(ra) # 80003622 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
    800056be:	04449703          	lh	a4,68(s1)
    800056c2:	4785                	li	a5,1
    800056c4:	f4f712e3          	bne	a4,a5,80005608 <sys_open+0x5e>
    800056c8:	f4c42783          	lw	a5,-180(s0)
    800056cc:	dba1                	beqz	a5,8000561c <sys_open+0x72>
      iunlockput(ip);
    800056ce:	8526                	mv	a0,s1
    800056d0:	ffffe097          	auipc	ra,0xffffe
    800056d4:	1b4080e7          	jalr	436(ra) # 80003884 <iunlockput>
      end_op();
    800056d8:	fffff097          	auipc	ra,0xfffff
    800056dc:	96a080e7          	jalr	-1686(ra) # 80004042 <end_op>
      return -1;
    800056e0:	557d                	li	a0,-1
    800056e2:	b76d                	j	8000568c <sys_open+0xe2>
      end_op();
    800056e4:	fffff097          	auipc	ra,0xfffff
    800056e8:	95e080e7          	jalr	-1698(ra) # 80004042 <end_op>
      return -1;
    800056ec:	557d                	li	a0,-1
    800056ee:	bf79                	j	8000568c <sys_open+0xe2>
    iunlockput(ip);
    800056f0:	8526                	mv	a0,s1
    800056f2:	ffffe097          	auipc	ra,0xffffe
    800056f6:	192080e7          	jalr	402(ra) # 80003884 <iunlockput>
    end_op();
    800056fa:	fffff097          	auipc	ra,0xfffff
    800056fe:	948080e7          	jalr	-1720(ra) # 80004042 <end_op>
    return -1;
    80005702:	557d                	li	a0,-1
    80005704:	b761                	j	8000568c <sys_open+0xe2>
      fileclose(f);
    80005706:	854a                	mv	a0,s2
    80005708:	fffff097          	auipc	ra,0xfffff
    8000570c:	d84080e7          	jalr	-636(ra) # 8000448c <fileclose>
    iunlockput(ip);
    80005710:	8526                	mv	a0,s1
    80005712:	ffffe097          	auipc	ra,0xffffe
    80005716:	172080e7          	jalr	370(ra) # 80003884 <iunlockput>
    end_op();
    8000571a:	fffff097          	auipc	ra,0xfffff
    8000571e:	928080e7          	jalr	-1752(ra) # 80004042 <end_op>
    return -1;
    80005722:	557d                	li	a0,-1
    80005724:	b7a5                	j	8000568c <sys_open+0xe2>
    f->type = FD_DEVICE;
    80005726:	00f92023          	sw	a5,0(s2)
    f->major = ip->major;
    8000572a:	04649783          	lh	a5,70(s1)
    8000572e:	02f91223          	sh	a5,36(s2)
    80005732:	bf21                	j	8000564a <sys_open+0xa0>
    itrunc(ip);
    80005734:	8526                	mv	a0,s1
    80005736:	ffffe097          	auipc	ra,0xffffe
    8000573a:	ffa080e7          	jalr	-6(ra) # 80003730 <itrunc>
    8000573e:	bf2d                	j	80005678 <sys_open+0xce>
...
sys_mkdir(void)
{
  ...
  iunlockput(ip);
    ...
    8000577e:	10a080e7          	jalr	266(ra) # 80003884 <iunlockput>
  end_op();
    80005782:	fffff097          	auipc	ra,0xfffff
    80005786:	8c0080e7          	jalr	-1856(ra) # 80004042 <end_op>
  return 0;
    8000578a:	4501                	li	a0,0
}
    8000578c:	60aa                	ld	ra,136(sp)
    8000578e:	640a                	ld	s0,128(sp)
    80005790:	6149                	add	sp,sp,144
    80005792:	8082                	ret
    end_op();
    80005794:	fffff097          	auipc	ra,0xfffff
    80005798:	8ae080e7          	jalr	-1874(ra) # 80004042 <end_op>
    return -1;
...
sys_mknod(void)
{
    800057a0:	7135                	add	sp,sp,-160
    800057a2:	ed06                	sd	ra,152(sp)
    800057a4:	e922                	sd	s0,144(sp)
    800057a6:	1100                	add	s0,sp,160
  struct inode *ip;
  char path[MAXPATH];
  int major, minor;
  ...
  begin_op();
    ...
    800057ac:	820080e7          	jalr	-2016(ra) # 80003fc8 <begin_op>
  argint(1, &major);
    800057b0:	f6c40593          	add	a1,s0,-148
    800057b4:	4505                	li	a0,1
    800057b6:	ffffd097          	auipc	ra,0xffffd
    800057ba:	30a080e7          	jalr	778(ra) # 80002ac0 <argint>
  argint(2, &minor);
    800057be:	f6840593          	add	a1,s0,-152
    800057c2:	4509                	li	a0,2
    800057c4:	ffffd097          	auipc	ra,0xffffd
    800057c8:	2fc080e7          	jalr	764(ra) # 80002ac0 <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    800057cc:	08000613          	li	a2,128
    800057d0:	f7040593          	add	a1,s0,-144
    800057d4:	4501                	li	a0,0
    800057d6:	ffffd097          	auipc	ra,0xffffd
    800057da:	32a080e7          	jalr	810(ra) # 80002b00 <argstr>
    800057de:	02054b63          	bltz	a0,80005814 <sys_mknod+0x74>
     (ip = create(path, T_DEVICE, major, minor)) == 0){
    800057e2:	f6841683          	lh	a3,-152(s0)
    800057e6:	f6c41603          	lh	a2,-148(s0)
    800057ea:	458d                	li	a1,3
    800057ec:	f7040513          	add	a0,s0,-144
    800057f0:	fffff097          	auipc	ra,0xfffff
    800057f4:	75a080e7          	jalr	1882(ra) # 80004f4a <create>
  if((argstr(0, path, MAXPATH)) < 0 ||
    800057f8:	cd11                	beqz	a0,80005814 <sys_mknod+0x74>
    end_op();
    return -1;
  }
  iunlockput(ip);
    800057fa:	ffffe097          	auipc	ra,0xffffe
    800057fe:	08a080e7          	jalr	138(ra) # 80003884 <iunlockput>
  end_op();
    80005802:	fffff097          	auipc	ra,0xfffff
    80005806:	840080e7          	jalr	-1984(ra) # 80004042 <end_op>
  return 0;
    8000580a:	4501                	li	a0,0
}
    8000580c:	60ea                	ld	ra,152(sp)
    8000580e:	644a                	ld	s0,144(sp)
    80005810:	610d                	add	sp,sp,160
    80005812:	8082                	ret
    end_op();
    80005814:	fffff097          	auipc	ra,0xfffff
    80005818:	82e080e7          	jalr	-2002(ra) # 80004042 <end_op>
    return -1;
    8000581c:	557d                	li	a0,-1
    8000581e:	b7fd                	j	8000580c <sys_mknod+0x6c>

0000000080005820 <sys_chdir>:

uint64
sys_chdir(void)
{
    80005820:	7135                	add	sp,sp,-160
    80005822:	ed06                	sd	ra,152(sp)
    80005824:	e922                	sd	s0,144(sp)
    80005826:	e526                	sd	s1,136(sp)
    80005828:	e14a                	sd	s2,128(sp)
    8000582a:	1100                	add	s0,sp,160
  char path[MAXPATH];
  struct inode *ip;
  struct proc *p = myproc();
    8000582c:	ffffc097          	auipc	ra,0xffffc
    80005830:	17a080e7          	jalr	378(ra) # 800019a6 <myproc>
    80005834:	892a                	mv	s2,a0
  
  begin_op();
    80005836:	ffffe097          	auipc	ra,0xffffe
    8000583a:	792080e7          	jalr	1938(ra) # 80003fc8 <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    8000583e:	08000613          	li	a2,128
    80005842:	f6040593          	add	a1,s0,-160
    80005846:	4501                	li	a0,0
    80005848:	ffffd097          	auipc	ra,0xffffd
    8000584c:	2b8080e7          	jalr	696(ra) # 80002b00 <argstr>
    80005850:	04054b63          	bltz	a0,800058a6 <sys_chdir+0x86>
    80005854:	f6040513          	add	a0,s0,-160
    80005858:	ffffe097          	auipc	ra,0xffffe
    8000585c:	570080e7          	jalr	1392(ra) # 80003dc8 <namei>
    80005860:	84aa                	mv	s1,a0
    80005862:	c131                	beqz	a0,800058a6 <sys_chdir+0x86>
    end_op();
    return -1;
  }
  ilock(ip);
    80005864:	ffffe097          	auipc	ra,0xffffe
    80005868:	dbe080e7          	jalr	-578(ra) # 80003622 <ilock>
  if(ip->type != T_DIR){
    8000586c:	04449703          	lh	a4,68(s1)
    80005870:	4785                	li	a5,1
    80005872:	04f71063          	bne	a4,a5,800058b2 <sys_chdir+0x92>
    iunlockput(ip);
    end_op();
    return -1;
  }
  iunlock(ip);
    ...
    8000587c:	e6c080e7          	jalr	-404(ra) # 800036e4 <iunlock>
  iput(p->cwd);
    80005880:	15093503          	ld	a0,336(s2)
    80005884:	ffffe097          	auipc	ra,0xffffe
    80005888:	f58080e7          	jalr	-168(ra) # 800037dc <iput>
  end_op();
    8000588c:	ffffe097          	auipc	ra,0xffffe
    80005890:	7b6080e7          	jalr	1974(ra) # 80004042 <end_op>
  p->cwd = ip;
    80005894:	14993823          	sd	s1,336(s2)
  return 0;
    80005898:	4501                	li	a0,0
}
    8000589a:	60ea                	ld	ra,152(sp)
    8000589c:	644a                	ld	s0,144(sp)
    8000589e:	64aa                	ld	s1,136(sp)
    800058a0:	690a                	ld	s2,128(sp)
    800058a2:	610d                	add	sp,sp,160
    800058a4:	8082                	ret
    end_op();
    800058a6:	ffffe097          	auipc	ra,0xffffe
    800058aa:	79c080e7          	jalr	1948(ra) # 80004042 <end_op>
    return -1;
    800058ae:	557d                	li	a0,-1
    800058b0:	b7ed                	j	8000589a <sys_chdir+0x7a>
    iunlockput(ip);
    800058b2:	8526                	mv	a0,s1
    800058b4:	ffffe097          	auipc	ra,0xffffe
    800058b8:	fd0080e7          	jalr	-48(ra) # 80003884 <iunlockput>
    end_op();
    800058bc:	ffffe097          	auipc	ra,0xffffe
    800058c0:	786080e7          	jalr	1926(ra) # 80004042 <end_op>
    return -1;
    800058c4:	557d                	li	a0,-1
    800058c6:	bfd1                	j	8000589a <sys_chdir+0x7a>

00000000800058c8 <sys_exec>:

uint64
sys_exec(void)
{
    800058c8:	7121                	add	sp,sp,-448
    800058ca:	ff06                	sd	ra,440(sp)
    800058cc:	fb22                	sd	s0,432(sp)
    800058ce:	f726                	sd	s1,424(sp)
    800058d0:	f34a                	sd	s2,416(sp)
    800058d2:	ef4e                	sd	s3,408(sp)
    800058d4:	eb52                	sd	s4,400(sp)
    800058d6:	0380                	add	s0,sp,448
  char path[MAXPATH], *argv[MAXARG];
  int i;
  uint64 uargv, uarg;

  argaddr(1, &uargv);
    800058d8:	e4840593          	add	a1,s0,-440
    800058dc:	4505                	li	a0,1
    800058de:	ffffd097          	auipc	ra,0xffffd
    800058e2:	202080e7          	jalr	514(ra) # 80002ae0 <argaddr>
  if(argstr(0, path, MAXPATH) < 0) {
    800058e6:	08000613          	li	a2,128
    800058ea:	f5040593          	add	a1,s0,-176
    800058ee:	4501                	li	a0,0
    800058f0:	ffffd097          	auipc	ra,0xffffd
    800058f4:	210080e7          	jalr	528(ra) # 80002b00 <argstr>
    800058f8:	87aa                	mv	a5,a0
    return -1;
    800058fa:	557d                	li	a0,-1
  if(argstr(0, path, MAXPATH) < 0) {
    800058fc:	0c07c263          	bltz	a5,800059c0 <sys_exec+0xf8>
  }
  memset(argv, 0, sizeof(argv));
    80005900:	10000613          	li	a2,256
    80005904:	4581                	li	a1,0
    80005906:	e5040513          	add	a0,s0,-432
    8000590a:	ffffb097          	auipc	ra,0xffffb
    8000590e:	3c4080e7          	jalr	964(ra) # 80000cce <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
    80005912:	e5040493          	add	s1,s0,-432
  memset(argv, 0, sizeof(argv));
    ...
    8000591e:	00391513          	sll	a0,s2,0x3
    80005922:	e4040593          	add	a1,s0,-448
    80005926:	e4843783          	ld	a5,-440(s0)
    8000592a:	953e                	add	a0,a0,a5
    8000592c:	ffffd097          	auipc	ra,0xffffd
    80005930:	0f6080e7          	jalr	246(ra) # 80002a22 <fetchaddr>
    80005934:	02054a63          	bltz	a0,80005968 <sys_exec+0xa0>
      goto bad;
    }
    if(uarg == 0){
    80005938:	e4043783          	ld	a5,-448(s0)
    8000593c:	c3b9                	beqz	a5,80005982 <sys_exec+0xba>
      argv[i] = 0;
      break;
    }
    argv[i] = kalloc();
    8000593e:	ffffb097          	auipc	ra,0xffffb
    80005942:	1a4080e7          	jalr	420(ra) # 80000ae2 <kalloc>
    80005946:	85aa                	mv	a1,a0
    80005948:	00a9b023          	sd	a0,0(s3)
    if(argv[i] == 0)
    8000594c:	cd11                	beqz	a0,80005968 <sys_exec+0xa0>
      goto bad;
    if(fetchstr(uarg, argv[i], PGSIZE) < 0)
    8000594e:	6605                	lui	a2,0x1
    80005950:	e4043503          	ld	a0,-448(s0)
    80005954:	ffffd097          	auipc	ra,0xffffd
    80005958:	120080e7          	jalr	288(ra) # 80002a74 <fetchstr>
    8000595c:	00054663          	bltz	a0,80005968 <sys_exec+0xa0>
    if(i >= NELEM(argv)){
    80005960:	0905                	add	s2,s2,1
    80005962:	09a1                	add	s3,s3,8
    80005964:	fb491de3          	bne	s2,s4,8000591e <sys_exec+0x56>
    kfree(argv[i]);
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005968:	f5040913          	add	s2,s0,-176
    8000596c:	6088                	ld	a0,0(s1)
    8000596e:	c921                	beqz	a0,800059be <sys_exec+0xf6>
    kfree(argv[i]);
    80005970:	ffffb097          	auipc	ra,0xffffb
    80005974:	074080e7          	jalr	116(ra) # 800009e4 <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005978:	04a1                	add	s1,s1,8
    8000597a:	ff2499e3          	bne	s1,s2,8000596c <sys_exec+0xa4>
  return -1;
    8000597e:	557d                	li	a0,-1
    80005980:	a081                	j	800059c0 <sys_exec+0xf8>
      argv[i] = 0;
    80005982:	0009079b          	sext.w	a5,s2
    80005986:	078e                	sll	a5,a5,0x3
    80005988:	fd078793          	add	a5,a5,-48
    8000598c:	97a2                	add	a5,a5,s0
    8000598e:	e807b023          	sd	zero,-384(a5)
  int ret = exec(path, argv);
    80005992:	e5040593          	add	a1,s0,-432
    80005996:	f5040513          	add	a0,s0,-176
    8000599a:	fffff097          	auipc	ra,0xfffff
    8000599e:	168080e7          	jalr	360(ra) # 80004b02 <exec>
    800059a2:	892a                	mv	s2,a0
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    800059a4:	f5040993          	add	s3,s0,-176
    800059a8:	6088                	ld	a0,0(s1)
    800059aa:	c901                	beqz	a0,800059ba <sys_exec+0xf2>
    kfree(argv[i]);
    800059ac:	ffffb097          	auipc	ra,0xffffb
    800059b0:	038080e7          	jalr	56(ra) # 800009e4 <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    800059b4:	04a1                	add	s1,s1,8
    800059b6:	ff3499e3          	bne	s1,s3,800059a8 <sys_exec+0xe0>
  return ret;
    800059ba:	854a                	mv	a0,s2
    800059bc:	a011                	j	800059c0 <sys_exec+0xf8>
  return -1;
    800059be:	557d                	li	a0,-1
}
    800059c0:	70fa                	ld	ra,440(sp)
    800059c2:	745a                	ld	s0,432(sp)
    800059c4:	74ba                	ld	s1,424(sp)
    800059c6:	791a                	ld	s2,416(sp)
    800059c8:	69fa                	ld	s3,408(sp)
    800059ca:	6a5a                	ld	s4,400(sp)
    800059cc:	6139                	add	sp,sp,448
    800059ce:	8082                	ret

00000000800059d0 <sys_pipe>:

uint64
sys_pipe(void)
{
    800059d0:	7139                	add	sp,sp,-64
    800059d2:	fc06                	sd	ra,56(sp)
    800059d4:	f822                	sd	s0,48(sp)
    800059d6:	f426                	sd	s1,40(sp)
    800059d8:	0080                	add	s0,sp,64
  uint64 fdarray; // user pointer to array of two integers
  struct file *rf, *wf;
  int fd0, fd1;
  struct proc *p = myproc();
    800059da:	ffffc097          	auipc	ra,0xffffc
    800059de:	fcc080e7          	jalr	-52(ra) # 800019a6 <myproc>
    800059e2:	84aa                	mv	s1,a0

  argaddr(0, &fdarray);
    800059e4:	fd840593          	add	a1,s0,-40
    800059e8:	4501                	li	a0,0
    800059ea:	ffffd097          	auipc	ra,0xffffd
    800059ee:	0f6080e7          	jalr	246(ra) # 80002ae0 <argaddr>
  if(pipealloc(&rf, &wf) < 0)
    800059f2:	fc840593          	add	a1,s0,-56
    800059f6:	fd040513          	add	a0,s0,-48
    800059fa:	fffff097          	auipc	ra,0xfffff
    800059fe:	dbe080e7          	jalr	-578(ra) # 800047b8 <pipealloc>
    return -1;
    80005a02:	57fd                	li	a5,-1
  if(pipealloc(&rf, &wf) < 0)
    80005a04:	0c054463          	bltz	a0,80005acc <sys_pipe+0xfc>
  fd0 = -1;
    80005a08:	fcf42223          	sw	a5,-60(s0)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    80005a0c:	fd043503          	ld	a0,-48(s0)
    80005a10:	fffff097          	auipc	ra,0xfffff
    80005a14:	4f8080e7          	jalr	1272(ra) # 80004f08 <fdalloc>
    80005a18:	fca42223          	sw	a0,-60(s0)
    80005a1c:	08054b63          	bltz	a0,80005ab2 <sys_pipe+0xe2>
    80005a20:	fc843503          	ld	a0,-56(s0)
    80005a24:	fffff097          	auipc	ra,0xfffff
    80005a28:	4e4080e7          	jalr	1252(ra) # 80004f08 <fdalloc>
    80005a2c:	fca42023          	sw	a0,-64(s0)
    80005a30:	06054863          	bltz	a0,80005aa0 <sys_pipe+0xd0>
      p->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    80005a36:	fc440613          	add	a2,s0,-60
    80005a3a:	fd843583          	ld	a1,-40(s0)
    80005a3e:	68a8                	ld	a0,80(s1)
    80005a40:	ffffc097          	auipc	ra,0xffffc
    80005a44:	c26080e7          	jalr	-986(ra) # 80001666 <copyout>
    80005a48:	02054063          	bltz	a0,80005a68 <sys_pipe+0x98>
     copyout(p->pagetable, fdarray+sizeof(fd0), (char *)&fd1, sizeof(fd1)) < 0){
    80005a4c:	4691                	li	a3,4
    80005a4e:	fc040613          	add	a2,s0,-64
    80005a52:	fd843583          	ld	a1,-40(s0)
    80005a56:	0591                	add	a1,a1,4
    80005a58:	68a8                	ld	a0,80(s1)
    80005a5a:	ffffc097          	auipc	ra,0xffffc
    80005a5e:	c0c080e7          	jalr	-1012(ra) # 80001666 <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  return 0;
    80005a62:	4781                	li	a5,0
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    80005a64:	06055463          	bgez	a0,80005acc <sys_pipe+0xfc>
    p->ofile[fd0] = 0;
    80005a68:	fc442783          	lw	a5,-60(s0)
    80005a6c:	07e9                	add	a5,a5,26
    80005a6e:	078e                	sll	a5,a5,0x3
    ...
    80005a7e:	94be                	add	s1,s1,a5
    80005a80:	0004b023          	sd	zero,0(s1)
    fileclose(rf);
    80005a84:	fd043503          	ld	a0,-48(s0)
    80005a88:	fffff097          	auipc	ra,0xfffff
    80005a8c:	a04080e7          	jalr	-1532(ra) # 8000448c <fileclose>
    fileclose(wf);
    ...
    80005a9e:	a03d                	j	80005acc <sys_pipe+0xfc>
    if(fd0 >= 0)
    80005aa0:	fc442783          	lw	a5,-60(s0)
    80005aa4:	0007c763          	bltz	a5,80005ab2 <sys_pipe+0xe2>
      p->ofile[fd0] = 0;
    80005aa8:	07e9                	add	a5,a5,26
    80005aaa:	078e                	sll	a5,a5,0x3
    80005aac:	97a6                	add	a5,a5,s1
    80005aae:	0007b023          	sd	zero,0(a5)
    fileclose(rf);
    80005ab2:	fd043503          	ld	a0,-48(s0)
    80005ab6:	fffff097          	auipc	ra,0xfffff
    80005aba:	9d6080e7          	jalr	-1578(ra) # 8000448c <fileclose>
    fileclose(wf);
    80005abe:	fc843503          	ld	a0,-56(s0)
    80005ac2:	fffff097          	auipc	ra,0xfffff
    80005ac6:	9ca080e7          	jalr	-1590(ra) # 8000448c <fileclose>
    return -1;
    80005aca:	57fd                	li	a5,-1
}
    80005acc:	853e                	mv	a0,a5
    80005ace:	70e2                	ld	ra,56(sp)
    80005ad0:	7442                	ld	s0,48(sp)
    80005ad2:	74a2                	ld	s1,40(sp)
    80005ad4:	6121                	add	sp,sp,64
    80005ad6:	8082                	ret
	...

0000000080005ae0 <kernelvec>:
    80005ae0:	7111                	add	sp,sp,-256
    ...
    80005b20:	dcffc0ef          	jal	800028ee <kerneltrap>
...
plicinithart(void)
{
    80005bb0:	1141                	add	sp,sp,-16
    80005bb2:	e406                	sd	ra,8(sp)
    80005bb4:	e022                	sd	s0,0(sp)
    80005bb6:	0800                	add	s0,sp,16
  int hart = cpuid();
    80005bb8:	ffffc097          	auipc	ra,0xffffc
    80005bbc:	dc2080e7          	jalr	-574(ra) # 8000197a <cpuid>
  
  // set enable bits for this hart's S-mode
  // for the uart and virtio disk.
  *(uint32*)PLIC_SENABLE(hart) = (1 << UART0_IRQ) | (1 << VIRTIO0_IRQ);
    80005bc0:	0085171b          	sllw	a4,a0,0x8
  ...
  *(uint32*)PLIC_SPRIORITY(hart) = 0;
    80005bd2:	00d5151b          	sllw	a0,a0,0xd
...
plic_claim(void)
{
    80005be8:	1141                	add	sp,sp,-16
    80005bea:	e406                	sd	ra,8(sp)
    80005bec:	e022                	sd	s0,0(sp)
    80005bee:	0800                	add	s0,sp,16
  int hart = cpuid();
    80005bf0:	ffffc097          	auipc	ra,0xffffc
    80005bf4:	d8a080e7          	jalr	-630(ra) # 8000197a <cpuid>
  int irq = *(uint32*)PLIC_SCLAIM(hart);
    80005bf8:	00d5151b          	sllw	a0,a0,0xd
...
free_desc(int i)
{
    80005c36:	1141                	add	sp,sp,-16
    80005c38:	e406                	sd	ra,8(sp)
    80005c3a:	e022                	sd	s0,0(sp)
    80005c3c:	0800                	add	s0,sp,16
  if(i >= NUM)
...
0000000080005cb8 <virtio_disk_init>:
{
  ...
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    ...
    80005ce8:	97678793          	add	a5,a5,-1674 # 74726976 <_entry-0xb8d968a>
  ...
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    ...
    80005d16:	55178793          	add	a5,a5,1361 # 554d4551 <_entry-0x2ab2baaf>
  ...
  *R(VIRTIO_MMIO_DRIVER_FEATURES) = features;
    ...
    80005d34:	75f68693          	add	a3,a3,1887 # ffffffffc7ffe75f <end+0xffffffff47fdc9ff>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    80005d7a:	eaa48493          	add	s1,s1,-342 # 80021c20 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    80005d9e:	e8e73703          	ld	a4,-370(a4) # 80021c28 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    80005db6:	e6e48493          	add	s1,s1,-402 # 80021c20 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
    ...
    80005ebc:	1880                	add	s0,sp,112
    80005ebe:	8a2a                	mv	s4,a0
    80005ec0:	8bae                	mv	s7,a1
  uint64 sector = b->blockno * (BSIZE / 512);
    80005ec2:	00c52c83          	lw	s9,12(a0)
    80005ec6:	001c9c9b          	sllw	s9,s9,0x1
    80005eca:	1c82                	sll	s9,s9,0x20
    80005ecc:	020cdc93          	srl	s9,s9,0x20

  acquire(&disk.vdisk_lock);
    80005ed0:	0001c517          	auipc	a0,0x1c
    80005ed4:	e7850513          	add	a0,a0,-392 # 80021d48 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005ee8:	d3cb0b13          	add	s6,s6,-708 # 80021c20 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    80005ef2:	e5ac0c13          	add	s8,s8,-422 # 80021d48 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005f3e:	cfc080e7          	jalr	-772(ra) # 80005c36 <free_desc>
      for(int j = 0; j < i; j++)
    80005f42:	0991                	add	s3,s3,4
    80005f44:	ffa999e3          	bne	s3,s10,80005f36 <virtio_disk_rw+0x94>
    sleep(&disk.free[0], &disk.vdisk_lock);
    80005f48:	85e2                	mv	a1,s8
    80005f4a:	0001c517          	auipc	a0,0x1c
    80005f4e:	cee50513          	add	a0,a0,-786 # 80021c38 <disk+0x18>
    80005f52:	ffffc097          	auipc	ra,0xffffc
    80005f56:	0fc080e7          	jalr	252(ra) # 8000204e <sleep>
  for(int i = 0; i < 3; i++){
    80005f5a:	f9040993          	add	s3,s0,-112
{
  ...
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    ...
    80005f68:	00a50713          	add	a4,a0,10
    80005f6c:	0712                	sll	a4,a4,0x4

  if(write)
    80005f6e:	0001c797          	auipc	a5,0x1c
    80005f72:	cb278793          	add	a5,a5,-846 # 80021c20 <disk>
  ...
  disk.desc[idx[0]].addr = (uint64) buf0;
    80005f88:	f6070613          	add	a2,a4,-160
    80005f8c:	6394                	ld	a3,0(a5)
    80005f8e:	96b2                	add	a3,a3,a2
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    80005f90:	00870593          	add	a1,a4,8
  ...
  disk.desc[idx[1]].addr = (uint64) b->data;
    80005fb0:	0692                	sll	a3,a3,0x4
    80005fb2:	9836                	add	a6,a6,a3
    80005fb4:	058a0613          	add	a2,s4,88
  ...
  if(write)
    ...
    80005fcc:	0016161b          	sllw	a2,a2,0x1
    disk.desc[idx[1]].flags = 0; // device reads b->data
  else
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
  disk.desc[idx[1]].flags |= VRING_DESC_F_NEXT;
    80005fd0:	00166613          	or	a2,a2,1
  ...
  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    80005fe0:	00250693          	add	a3,a0,2
    80005fe4:	0692                	sll	a3,a3,0x4
    80005fe6:	96be                	add	a3,a3,a5
    80005fe8:	58fd                	li	a7,-1
    80005fea:	01168823          	sb	a7,16(a3)
  disk.desc[idx[2]].addr = (uint64) &disk.info[idx[0]].status;
    80005fee:	0612                	sll	a2,a2,0x4
    80005ff0:	9832                	add	a6,a6,a2
    80005ff2:	f9070713          	add	a4,a4,-112
  ...
  disk.avail->ring[disk.avail->idx % NUM] = idx[0];
    ...
    8000601a:	8b1d                	and	a4,a4,7
    8000601c:	0706                	sll	a4,a4,0x1
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80006048:	d0490913          	add	s2,s2,-764 # 80021d48 <disk+0x128>
  while(b->disk == 1) {
    ...
    8000605a:	ff8080e7          	jalr	-8(ra) # 8000204e <sleep>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    8000606a:	00290713          	add	a4,s2,2
    8000606e:	0712                	sll	a4,a4,0x4
    80006070:	0001c797          	auipc	a5,0x1c
    80006074:	bb078793          	add	a5,a5,-1104 # 80021c20 <disk>
    80006078:	97ba                	add	a5,a5,a4
    8000607a:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    8000607e:	0001c997          	auipc	s3,0x1c
    80006082:	ba298993          	add	s3,s3,-1118 # 80021c20 <disk>
    80006086:	00491713          	sll	a4,s2,0x4
...
virtio_disk_intr()
{
    ...
    800060da:	1000                	add	s0,sp,32
  acquire(&disk.vdisk_lock);
    800060dc:	0001c497          	auipc	s1,0x1c
    800060e0:	b4448493          	add	s1,s1,-1212 # 80021c20 <disk>
    800060e4:	0001c517          	auipc	a0,0x1c
    800060e8:	c6450513          	add	a0,a0,-924 # 80021d48 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    8000611a:	8b9d                	and	a5,a5,7
    8000611c:	078e                	sll	a5,a5,0x3
    8000611e:	97ba                	add	a5,a5,a4
    80006120:	43dc                	lw	a5,4(a5)

    if(disk.info[id].status != 0)
    80006122:	00278713          	add	a4,a5,2
    80006126:	0712                	sll	a4,a4,0x4
    ...
    80006130:	0789                	add	a5,a5,2
    80006132:	0792                	sll	a5,a5,0x4
    ...
    80006140:	f76080e7          	jalr	-138(ra) # 800020b2 <wakeup>

    disk.used_idx += 1;
    80006144:	0204d783          	lhu	a5,32(s1)
    80006148:	2785                	addw	a5,a5,1
    8000614a:	17c2                	sll	a5,a5,0x30
    8000614c:	93c1                	srl	a5,a5,0x30
  ...
  release(&disk.vdisk_lock);
    ...
    80006160:	bec50513          	add	a0,a0,-1044 # 80021d48 <disk+0x128>
    ...
    8000617a:	6ca50513          	add	a0,a0,1738 # 80008840 <syscalls+0x3f0>
