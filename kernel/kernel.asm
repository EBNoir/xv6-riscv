...
r_mhartid()
{
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
  ...
  uint64 *scratch = &timer_scratch[id][0];
    ...
    80000054:	88070713          	add	a4,a4,-1920 # 800088d0 <timer_scratch>
...
000000008000008c <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    8000009a:	7ff70713          	add	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdcabf>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    80000188:	88c50513          	add	a0,a0,-1908 # 80010a10 <cons>
  ...
  while(n > 0){
    ...
    80000198:	87c48493          	add	s1,s1,-1924 # 80010a10 <cons>
      if(killed(myproc())){
        release(&cons.lock);
        return -1;
      }
    ...
    800001a0:	90c90913          	add	s2,s2,-1780 # 80010aa8 <cons+0x98>
  while(n > 0){
    ...
    800001e2:	83270713          	add	a4,a4,-1998 # 80010a10 <cons>
  ...
  release(&cons.lock);
    ...
    8000022c:	7e850513          	add	a0,a0,2024 # 80010a10 <cons>
  ...
  return target - n;
    ...
    80000242:	7d250513          	add	a0,a0,2002 # 80010a10 <cons>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    800002cc:	74850513          	add	a0,a0,1864 # 80010a10 <cons>
  ...
  release(&cons.lock);
    ...
    800002fa:	71a50513          	add	a0,a0,1818 # 80010a10 <cons>
  ...
  switch(c){
    ...
    8000031e:	6f670713          	add	a4,a4,1782 # 80010a10 <cons>
    ...
    80000348:	6cc78793          	add	a5,a5,1740 # 80010a10 <cons>
    ...
    8000038a:	68a70713          	add	a4,a4,1674 # 80010a10 <cons>
    8000038e:	0a072783          	lw	a5,160(a4)
    80000392:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF_SIZE] != '\n'){
    80000396:	00010497          	auipc	s1,0x10
    8000039a:	67a48493          	add	s1,s1,1658 # 80010a10 <cons>
    while(cons.e != cons.w &&
    ...
    800003d6:	63e70713          	add	a4,a4,1598 # 80010a10 <cons>
    ...
    80000412:	60278793          	add	a5,a5,1538 # 80010a10 <cons>
    ...
    8000043e:	66e50513          	add	a0,a0,1646 # 80010aa8 <cons+0x98>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80000460:	5b450513          	add	a0,a0,1460 # 80010a10 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    80000478:	73478793          	add	a5,a5,1844 # 80020ba8 <devsw>
...
0000000080000586 <printf>:
{
  ...
  consputc('x');
    ...
    800005fa:	4c250513          	add	a0,a0,1218 # 80010ab8 <pr>
  ...
  if(locking)
    ...
    80000758:	36450513          	add	a0,a0,868 # 80010ab8 <pr>
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    ...
    80000774:	34848493          	add	s1,s1,840 # 80010ab8 <pr>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    800007d4:	30850513          	add	a0,a0,776 # 80010ad8 <uart_tx_lock>
    ...
    80000844:	06f70a63          	beq	a4,a5,800008b8 <uartstart+0x84>
{
    ...
    80000862:	27aa0a13          	add	s4,s4,634 # 80010ad8 <uart_tx_lock>
    uart_tx_r += 1;
    80000866:	00008497          	auipc	s1,0x8
    8000086a:	03248493          	add	s1,s1,50 # 80008898 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    8000086e:	00008997          	auipc	s3,0x8
    80000872:	03298993          	add	s3,s3,50 # 800088a0 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
...
00000000800008ba <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    ...
    800008d0:	20c50513          	add	a0,a0,524 # 80010ad8 <uart_tx_lock>
  ...
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    ...
    800008fe:	1de98993          	add	s3,s3,478 # 80010ad8 <uart_tx_lock>
    80000902:	00008497          	auipc	s1,0x8
    80000906:	f9648493          	add	s1,s1,-106 # 80008898 <uart_tx_r>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    8000090a:	00008917          	auipc	s2,0x8
    8000090e:	f9690913          	add	s2,s2,-106 # 800088a0 <uart_tx_w>
  ...
  uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    ...
    80000934:	1a848493          	add	s1,s1,424 # 80010ad8 <uart_tx_lock>
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    800009ba:	12248493          	add	s1,s1,290 # 80010ad8 <uart_tx_lock>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    800009fc:	34878793          	add	a5,a5,840 # 80021d40 <end>
  ...
  acquire(&kmem.lock);
    ...
    80000a1c:	0f890913          	add	s2,s2,248 # 80010b10 <kmem>
...
0000000080000aa6 <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    80000aba:	05a50513          	add	a0,a0,90 # 80010b10 <kmem>
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000ace:	27650513          	add	a0,a0,630 # 80021d40 <end>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000af0:	02448493          	add	s1,s1,36 # 80010b10 <kmem>
  ...
  if(r)
    ...
    80000b08:	00c50513          	add	a0,a0,12 # 80010b10 <kmem>
  ...
  release(&kmem.lock);
    ...
    80000b34:	fe050513          	add	a0,a0,-32 # 80010b10 <kmem>
    ...
    80000d3a:	00c587b3          	add	a5,a1,a2
{
    ...
    80000d42:	0705                	add	a4,a4,1 # fffffffffffff001 <end+0xffffffff7ffdd2c1>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000e86:	a2670713          	add	a4,a4,-1498 # 800088a8 <started>
  if(cpuid() == 0){
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  for(int level = 2; level > 0; level--) {
    80001010:	3a5d                	addw	s4,s4,-9 # ffffffffffffeff7 <end+0xffffffff7ffdd2b7>
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000184a:	71a48493          	add	s1,s1,1818 # 80010f60 <proc>
    char *pa = kalloc();
    if(pa == 0)
      panic("kalloc");
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001864:	100a0a13          	add	s4,s4,256 # 80016960 <tickslock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    800018e6:	24e50513          	add	a0,a0,590 # 80010b30 <pid_lock>
  ...
  initlock(&wait_lock, "wait_lock");
    ...
    800018fe:	24e50513          	add	a0,a0,590 # 80010b48 <wait_lock>
    80001902:	fffff097          	auipc	ra,0xfffff
    80001906:	240080e7          	jalr	576(ra) # 80000b42 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
    8000190a:	0000f497          	auipc	s1,0xf
    8000190e:	65648493          	add	s1,s1,1622 # 80010f60 <proc>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001930:	03498993          	add	s3,s3,52 # 80016960 <tickslock>
      initlock(&p->lock, "proc");
...
mycpu(void)
{
  ...
  return c;
    ...
    8000199a:	1ca50513          	add	a0,a0,458 # 80010b60 <cpus>
...
myproc(void)
{
  ...
  struct proc *p = c->proc;
    ...
    800019c2:	17270713          	add	a4,a4,370 # 80010b30 <pid_lock>
...
0000000080001a24 <allocpid>:
{
  ...
  acquire(&pid_lock);
    ...
    80001a34:	10090913          	add	s2,s2,256 # 80010b30 <pid_lock>
...
0000000080001bb0 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001bc0:	3a448493          	add	s1,s1,932 # 80010f60 <proc>
    80001bc4:	00015917          	auipc	s2,0x15
    80001bc8:	d9c90913          	add	s2,s2,-612 # 80016960 <tickslock>
    acquire(&p->lock);
...
0000000080001d5c <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  acquire(&wait_lock);
    ...
    80001e4e:	cfe48493          	add	s1,s1,-770 # 80010b48 <wait_lock>
...
0000000080001e9c <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001ebc:	c7870713          	add	a4,a4,-904 # 80010b30 <pid_lock>
    80001ec0:	9756                	add	a4,a4,s5
    80001ec2:	02073823          	sd	zero,48(a4)
        swtch(&c->context, &p->context);
    80001ec6:	0000f717          	auipc	a4,0xf
    80001eca:	ca270713          	add	a4,a4,-862 # 80010b68 <cpus+0x8>
    ...
    80001eda:	c5aa0a13          	add	s4,s4,-934 # 80010b30 <pid_lock>
    80001ede:	9a3e                	add	s4,s4,a5
    for(p = proc; p < &proc[NPROC]; p++) {
    80001ee0:	00015917          	auipc	s2,0x15
    80001ee4:	a8090913          	add	s2,s2,-1408 # 80016960 <tickslock>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001ef8:	06c48493          	add	s1,s1,108 # 80010f60 <proc>
...
0000000080001f3c <sched>:
{
  ...
  if(mycpu()->noff != 1)
    ...
    80001f68:	bcc70713          	add	a4,a4,-1076 # 80010b30 <pid_lock>
  ...
  intena = mycpu()->intena;
    ...
    80001f8e:	ba690913          	add	s2,s2,-1114 # 80010b30 <pid_lock>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    80001fa6:	bc658593          	add	a1,a1,-1082 # 80010b68 <cpus+0x8>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800020ca:	e9a48493          	add	s1,s1,-358 # 80010f60 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800020d6:	88e90913          	add	s2,s2,-1906 # 80016960 <tickslock>
...
0000000080002128 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    8000213e:	e2648493          	add	s1,s1,-474 # 80010f60 <proc>
      pp->parent = initproc;
    80002142:	00006a17          	auipc	s4,0x6
    80002146:	776a0a13          	add	s4,s4,1910 # 800088b8 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    8000214a:	00015997          	auipc	s3,0x15
    8000214e:	81698993          	add	s3,s3,-2026 # 80016960 <tickslock>
...
0000000080002182 <exit>:
{
  ...
  acquire(&wait_lock);
    ...
    800021fe:	94e48493          	add	s1,s1,-1714 # 80010b48 <wait_lock>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000226c:	cf848493          	add	s1,s1,-776 # 80010f60 <proc>
    80002270:	00014997          	auipc	s3,0x14
    80002274:	6f098993          	add	s3,s3,1776 # 80016960 <tickslock>
    acquire(&p->lock);
...
0000000080002328 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    80002350:	7fc50513          	add	a0,a0,2044 # 80010b48 <wait_lock>
    ...
    80002366:	5fe98993          	add	s3,s3,1534 # 80016960 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    8000236a:	0000ec17          	auipc	s8,0xe
    8000236e:	7dec0c13          	add	s8,s8,2014 # 80010b48 <wait_lock>
    ...
    800023ac:	7a050513          	add	a0,a0,1952 # 80010b48 <wait_lock>
    ...
    800023e0:	76c50513          	add	a0,a0,1900 # 80010b48 <wait_lock>
    ...
    8000243c:	b2848493          	add	s1,s1,-1240 # 80010f60 <proc>
    80002440:	bf65                	j	800023f8 <wait+0xd0>
      release(&wait_lock);
    80002442:	0000e517          	auipc	a0,0xe
    80002446:	70650513          	add	a0,a0,1798 # 80010b48 <wait_lock>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000252c:	b9048493          	add	s1,s1,-1136 # 800110b8 <proc+0x158>
    80002530:	00014917          	auipc	s2,0x14
    80002534:	58890913          	add	s2,s2,1416 # 80016ab8 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80002630:	33450513          	add	a0,a0,820 # 80016960 <tickslock>
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80002700:	26448493          	add	s1,s1,612 # 80016960 <tickslock>
  ...
  ticks++;
    ...
    80002712:	1b250513          	add	a0,a0,434 # 800088c0 <ticks>
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    80002c8e:	cd650513          	add	a0,a0,-810 # 80016960 <tickslock>
  ...
  while(ticks - ticks0 < n){
    ...
    80002cac:	cb898993          	add	s3,s3,-840 # 80016960 <tickslock>
    80002cb0:	00006497          	auipc	s1,0x6
    80002cb4:	c1048493          	add	s1,s1,-1008 # 800088c0 <ticks>
    if(killed(myproc())){
  ...
  release(&tickslock);
    ...
    80002ce8:	c7c50513          	add	a0,a0,-900 # 80016960 <tickslock>
  ...
  return 0;
    ...
    80002d08:	c5c50513          	add	a0,a0,-932 # 80016960 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002d50:	c1450513          	add	a0,a0,-1004 # 80016960 <tickslock>
  ...
  release(&tickslock);
    ...
    80002d68:	bfc50513          	add	a0,a0,-1028 # 80016960 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002da0:	bdc50513          	add	a0,a0,-1060 # 80016978 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    80002db0:	bcc78793          	add	a5,a5,-1076 # 8001e978 <bcache+0x8000>
    80002db4:	0001c717          	auipc	a4,0x1c
    80002db8:	e2c70713          	add	a4,a4,-468 # 8001ebe0 <bcache+0x8268>
    80002dbc:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002dc0:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002dc4:	00014497          	auipc	s1,0x14
    80002dc8:	bcc48493          	add	s1,s1,-1076 # 80016990 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002e28:	b5450513          	add	a0,a0,-1196 # 80016978 <bcache>
  ...
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    80002e40:	da478793          	add	a5,a5,-604 # 8001ebe0 <bcache+0x8268>
    ...
    80002e68:	b1450513          	add	a0,a0,-1260 # 80016978 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002e8e:	d5678793          	add	a5,a5,-682 # 8001ebe0 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002ec6:	ab650513          	add	a0,a0,-1354 # 80016978 <bcache>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002f6e:	a0e50513          	add	a0,a0,-1522 # 80016978 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    80002f94:	9e878793          	add	a5,a5,-1560 # 8001e978 <bcache+0x8000>
    80002f98:	2b87b703          	ld	a4,696(a5)
    80002f9c:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002f9e:	0001c717          	auipc	a4,0x1c
    80002fa2:	c4270713          	add	a4,a4,-958 # 8001ebe0 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002fb6:	9c650513          	add	a0,a0,-1594 # 80016978 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002fee:	98e50513          	add	a0,a0,-1650 # 80016978 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003004:	97850513          	add	a0,a0,-1672 # 80016978 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000302a:	95250513          	add	a0,a0,-1710 # 80016978 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003040:	93c50513          	add	a0,a0,-1732 # 80016978 <bcache>
...
00000000800030d2 <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    800030fe:	f3eb0b13          	add	s6,s6,-194 # 8001f038 <sb>
...
00000000800032ee <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80003306:	d5650513          	add	a0,a0,-682 # 8001f058 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003318:	d5c48493          	add	s1,s1,-676 # 8001f070 <itable+0x18>
    8000331c:	0001d697          	auipc	a3,0x1d
    80003320:	7e468693          	add	a3,a3,2020 # 80020b00 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    8000334c:	d1050513          	add	a0,a0,-752 # 8001f058 <itable>
  ...
  release(&itable.lock);
    ...
    8000337c:	ce050513          	add	a0,a0,-800 # 8001f058 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    800033ca:	c7298993          	add	s3,s3,-910 # 8001f038 <sb>
  ...
  initlog(dev, &sb);
    ...
    800033fe:	c3e58593          	add	a1,a1,-962 # 8001f038 <sb>
...
000000008000342a <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003444:	c1850513          	add	a0,a0,-1000 # 8001f058 <itable>
    80003448:	ffffd097          	auipc	ra,0xffffd
    8000344c:	6fa080e7          	jalr	1786(ra) # 80000b42 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003450:	0001c497          	auipc	s1,0x1c
    80003454:	c3048493          	add	s1,s1,-976 # 8001f080 <itable+0x28>
    80003458:	0001d997          	auipc	s3,0x1d
    8000345c:	6b898993          	add	s3,s3,1720 # 80020b10 <log+0x10>
...
000000008000348a <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    800034b6:	b86a0a13          	add	s4,s4,-1146 # 8001f038 <sb>
...
00000000800035e4 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    800035f4:	a6850513          	add	a0,a0,-1432 # 8001f058 <itable>
  ...
  release(&itable.lock);
    ...
    8000360a:	a5250513          	add	a0,a0,-1454 # 8001f058 <itable>
...
00000000800037dc <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    800037ee:	86e50513          	add	a0,a0,-1938 # 8001f058 <itable>
  ...
  release(&itable.lock);
    ...
    8000380c:	85050513          	add	a0,a0,-1968 # 8001f058 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80003840:	81c50513          	add	a0,a0,-2020 # 8001f058 <itable>
    ...
    80003876:	7e650513          	add	a0,a0,2022 # 8001f058 <itable>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80003e12:	cf290913          	add	s2,s2,-782 # 80020b00 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003e36:	cfe70713          	add	a4,a4,-770 # 80020b30 <log+0x30>
    ...
    80003e74:	0af05d63          	blez	a5,80003f2e <install_trans+0xc2>
{
    ...
    80003e92:	ca2a8a93          	add	s5,s5,-862 # 80020b30 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003e96:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003e98:	0001d997          	auipc	s3,0x1d
    80003e9c:	c6898993          	add	s3,s3,-920 # 80020b00 <log>
...
0000000080003f30 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003f46:	bbe48493          	add	s1,s1,-1090 # 80020b00 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003f84:	bb070713          	add	a4,a4,-1104 # 80020b30 <log+0x30>
...
begin_op(void)
{
  ...
  while(1){
    ...
    80004028:	adc50513          	add	a0,a0,-1316 # 80020b00 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80004058:	aac48493          	add	s1,s1,-1364 # 80020b00 <log>
  ...
  if(log.outstanding == 0){
    ...
    8000407c:	a8848493          	add	s1,s1,-1400 # 80020b00 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80004098:	a6c48493          	add	s1,s1,-1428 # 80020b00 <log>
    ...
    800040d4:	a3048493          	add	s1,s1,-1488 # 80020b00 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80004102:	a32a8a93          	add	s5,s5,-1486 # 80020b30 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80004106:	0001da17          	auipc	s4,0x1d
    8000410a:	9faa0a13          	add	s4,s4,-1542 # 80020b00 <log>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800041ac:	95890913          	add	s2,s2,-1704 # 80020b00 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800041ea:	94a70713          	add	a4,a4,-1718 # 80020b30 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004206:	8fe78793          	add	a5,a5,-1794 # 80020b00 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    8000421e:	8e670713          	add	a4,a4,-1818 # 80020b00 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004254:	8b070713          	add	a4,a4,-1872 # 80020b00 <log>
  ...
  release(&log.lock);
    ...
    80004266:	89e50513          	add	a0,a0,-1890 # 80020b00 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800043bc:	89050513          	add	a0,a0,-1904 # 80020c48 <ftable>
...
filealloc(void)
{
  ...
  release(&ftable.lock);
    ...
    8000440a:	84250513          	add	a0,a0,-1982 # 80020c48 <ftable>
  ...
  return 0;
    ...
    80004422:	82a50513          	add	a0,a0,-2006 # 80020c48 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000444a:	80250513          	add	a0,a0,-2046 # 80020c48 <ftable>
  ...
  release(&ftable.lock);
    ...
    80004464:	7e850513          	add	a0,a0,2024 # 80020c48 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800044a4:	7a850513          	add	a0,a0,1960 # 80020c48 <ftable>
  ...
  release(&ftable.lock);
    ...
    800044de:	76e50513          	add	a0,a0,1902 # 80020c48 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    80004528:	72450513          	add	a0,a0,1828 # 80020c48 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    8000465a:	55270713          	add	a4,a4,1362 # 80020ba8 <devsw>
    ...
    8000468c:	10078e63          	beqz	a5,800047a8 <filewrite+0x120>
{
  ...
  if(f->type == FD_PIPE){
    ...
    800046f8:	4b470713          	add	a4,a4,1204 # 80020ba8 <devsw>
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  ustack[argc] = 0;
    ...
    80004dc4:	f9078793          	add	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffdd250>
